...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\XAMPP\htdocs\Digisted\digisted-app\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\XAMPP\\htdocs\\Digisted\\digisted-app\\public\\storage',
...
'validation.uuid','validation.custom.attribute-name.rule-name','messages.login.success','messages.login.failed','messages.login.invalid_credentials',
'messages.logout.success','messages.logout.failed','messages.renew.success','messages.renew.failed','messages.renew.user_not_found',
'messages.user.success','messages.user.not_found','messages.register.success','messages.register.failed','messages.register.email_exists',
'messages.validation.name_required','messages.validation.email_required','messages.validation.email_email','messages.validation.email_unique','messages.validation.password_required',
'messages.validation.password_confirmed','messages.validation.title_required','messages.validation.title_string','messages.validation.title_max','messages.validation.description_required',
'messages.validation.description_string','messages.validation.status_required','messages.validation.status_in','messages.validation.due_date_date','messages.task.get_all',
'messages.task.get','messages.task.get_failed','messages.task.not_found','messages.task.created','messages.task.create_failed',
'messages.task.updated','messages.task.update_failed','messages.task.deleted','messages.task.delete_failed','messages.task.restored',
'messages.task.restore_failed','messages.task.get_all_deleted','messages.task.no_ids_provided','messages.task.bulk_deleted','messages.task.bulk_delete_failed',
'messages.task.bulk_restored','messages.task.bulk_restore_failed','messages.task.bulk_force_delete_failed','messages.task.partial_bulk_deleted','messages.task.partial_bulk_restored',
'messages.task.partial_bulk_force_deleted','messages.task.bulk_force_deleted',);
